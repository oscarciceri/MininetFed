...
# # # check args
# if (n < 2):
#     print("correct use: sudo python3 trainingLog.py <*.log> ...")
#     exit()
...
header = ['Round'] + ['Round Delta T'] + ['Acurácia Média']
    # [f'Cliente {i+1}' for i in range(len(csv_data[0])-3)] +\
